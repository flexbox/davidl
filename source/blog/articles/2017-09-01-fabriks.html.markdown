...
Ce sont souvent des sites basiques Prestashop, Magento ou Wordpress sans aucune [stratédie de contenu](/blog/fin-psd.html), ni hierachie dans le catalogue. À cela, on a rajouté tous les plugins de partage sur les réseaux sociaux et les 1001 fonctionnalités inutiles pour avoir un site super lent.
