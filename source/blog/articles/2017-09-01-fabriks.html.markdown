...
Ce sont souvent des sites basiques Prestashop, Magento ou Wordpress sans aucune [stratédie de contenu](/blog/fin-psd.html), ni hiérachie dans le catalogue. À cela, on a rajouté tout les plugins de partage sur les réseaux sociaux et les 1001 fonctionnalités inutiles pour avoir un site super lent.
...
Après plusieurs itérations sur différentes technologies [fabriks.net](https://fabriks.net/) est en ligne et nous sommes fiers du résultat.
...
Les pages qui sont traditionnellement générées par le navigateur de l’utilisateur sont compilées par le serveur et envoyés par la suite au client.
